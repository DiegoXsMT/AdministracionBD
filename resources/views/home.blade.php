    ...
    <div class="container">
        ...
        <div class="">
            <div class="row ">
                    ...
                    <div class="row">
                        <div class="col">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                ...
                                style="width: 70%; height: 70%; margin-top: 4rem; margin-left:60px">
                                <path
                ...
                <div class="col-md-5 ">
                    <div class="row ">
                        <span class="row justify-content-center" style="font-weight: bold"> Tus movimientos del ultimo
                            mes</span>
                    </div>

                    <div class="row ">
                        <div class="row ">
                            <img src="images/telcel.jpg" class="rounded float-start" alt="..."
                                style="width: 12rem; margin-left: 1rem">
                            <img src="images/grafica.png" class="rounded float-end" alt="..."
                                style="width: 12rem; margin-left: 7rem">
                        </div>
                        <div class="row  d-flex justify-content-center">
                            <div class="col text-center">
                                <span> Exclusivo y pensado para ti. Experiencias Telcel. ¿Sabías que puedes ganar premios
                                    increíbles por ser Telcel?</span>
                            </div>
                            <div class="col text-center">
                    ...
                    <div class="row ">
                        <div class="row ">
                            <img src="images/apple.jpg" class="rounded float-start" alt="..."
                                style="width: 12rem; margin-left: 1rem">
                            <img src="images/grafica.png" class="rounded float-end" alt="..."
                                style="width: 12rem; margin-left: 7rem">
                        </div>
                        <div class="row  d-flex justify-content-center">
                            <div class="col text-center">
                                <span> Descubre el innovador mundo de Apple: iPhone, iPad, Apple Watch, Mac, Apple TV,
                                    accesorios, entretenimiento y soporte técnico.</span>
                            </div>
                            <div class="col text-center">
                                <span style="margin-left: 3rem">Rendimiento grafico</span>
                            </div>
